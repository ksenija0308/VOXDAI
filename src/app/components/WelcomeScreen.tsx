...
export default function WelcomeScreen({ formData, updateFormData, nextScreen, onShowSignIn }: WelcomeScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-6 bg-gradient-to-br from-[#f9fafb] via-white to-[#f3f4f6]">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left: Content */}
            <div>
              <div className="inline-flex items-center gap-2 bg-[#0B3B2E]/10 px-4 py-2 rounded-full mb-6">
                <Sparkles className="w-4 h-4 text-[#0B3B2E]" />
                <span className="text-[#0B3B2E]" style={{ fontSize: '14px', fontWeight: '600', fontFamily: 'Inter, sans-serif' }}>
              ...
              <p
                className="text-[#717182] mb-8 text-lg max-w-xl"
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                <Button
                  ...
                  className="bg-[#0B3B2E] text-white hover:bg-[#0B3B2E]/90 h-14 px-8 text-lg"
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-2 border-[#0B3B2E] text-[#0B3B2E] hover:bg-[#0B3B2E] hover:text-white h-14 px-8 text-lg"
                  style={{ fontFamily: 'Inter, sans-serif', fontWeight: '600' }}
                >
      ...
      <section id="features" className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              className="text-[#717182] text-lg max-w-2xl mx-auto"
              style={{ fontFamily: 'Inter, sans-serif' }}
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="p-8 border-2 border-[#e9ebef] rounded-2xl hover:border-[#0B3B2E] hover:shadow-xl transition-all"
              >
                <div className="w-14 h-14 bg-[#0B3B2E] rounded-xl flex items-center justify-center mb-4">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20 px-6 bg-gradient-to-br from-[#f9fafb] to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2
              className="text-5xl mb-4"
          ...
          <div className="mb-20">
            <div className="flex items-center gap-3 mb-8">
              <Users className="w-8 h-8 text-[#0B3B2E]" />
              <h3
                className="text-3xl"
                style={{ fontFamily: 'Helvetica, Arial, sans-serif', fontWeight: 'bold' }}
              >
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                <div key={index} className="relative">
                  <div className="bg-white border-2 border-[#e9ebef] rounded-2xl p-6 hover:border-[#0B3B2E] transition-all h-full">
                    <div className="w-12 h-12 bg-[#0B3B2E] rounded-xl flex items-center justify-center mb-4">
                  ...
                  {index < 3 && (
                    <ArrowRight className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-[#0B3B2E] w-6 h-6" />
                  )}
                </div>
              ))}
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              <Mic className="w-8 h-8 text-[#0B3B2E]" />
              <h3
                className="text-3xl"
                style={{ fontFamily: 'Helvetica, Arial, sans-serif', fontWeight: 'bold' }}
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p
                className="text-[#717182] text-lg mb-8"
                style={{ fontFamily: 'Inter, sans-serif', lineHeight: '1.8' }}
              >
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#0B3B2E]/10 rounded-xl flex items-center justify-center flex-shrink-0">
                      <benefit.icon className="w-6 h-6 text-[#0B3B2E]" />
                    </div>
                    <div>
                      <h4
            ...
            <div className="bg-gradient-to-br from-[#0B3B2E] to-[#164d3c] rounded-3xl p-12 text-white">
              <h3
                ...
                <div className="bg-white/10 backdrop-blur rounded-2xl p-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white/80 text-sm">Conference Director, TechSummit</div>
                    </div>
                  </div>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-2xl p-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white/80 text-sm">Keynote Speaker, AI & Innovation</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-6 bg-gradient-to-br from-[#0B3B2E] to-[#164d3c]">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Button
              onClick={() => handleSelectUserType('organizer')}
              className="bg-white text-[#0B3B2E] hover:bg-white/90 h-14 px-8 text-lg"
              style={{ fontFamily: 'Inter, sans-serif', fontWeight: '600' }}
            >
              <Users className="w-5 h-5 mr-2" />
              Start as Organizer
            ...
            <Button
              onClick={() => handleSelectUserType('speaker')}
              variant="outline"
              className="border-2 border-white text-white bg-white/10 hover:bg-white hover:text-[#0B3B2E] h-14 px-8 text-lg"
              style={{ fontFamily: 'Inter, sans-serif', fontWeight: '600' }}
            >
              <Mic className="w-5 h-5 mr-2" />
              Start as Speaker
          ...
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="p-8">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-[#0B3B2E] rounded-xl flex items-center justify-center">
                ...
                <button
                  ...
                  className="w-10 h-10 rounded-full hover:bg-[#f3f4f6] flex items-center justify-center transition-colors"
                >
              ...
              <form onSubmit={handleContactSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-[#e9ebef] rounded-xl focus:border-[#0B3B2E] focus:outline-none transition-colors"
                      style={{ fontFamily: 'Inter, sans-serif' }}
                      placeholder="John"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border-2 border-[#e9ebef] rounded-xl focus:border-[#0B3B2E] focus:outline-none transition-colors resize-none"
                    style={{ fontFamily: 'Inter, sans-serif' }}
                ...
                <div className="flex gap-4">
                  <Button
                    ...
                    className="flex-1 bg-[#0B3B2E] text-white hover:bg-[#0B3B2E]/90 h-12 disabled:opacity-50 disabled:cursor-not-allowed"
                    style={{ fontFamily: 'Inter, sans-serif', fontWeight: '600' }}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => setShowContactForm(false)}
                    variant="outline"
                    className="border-2 border-[#e9ebef] text-[#717182] hover:border-[#0B3B2E] hover:text-[#0B3B2E] h-12"
                    style={{ fontFamily: 'Inter, sans-serif', fontWeight: '600' }}
                  >
                    Cancel
                  </Button>
      ...
      <footer className="bg-white text-black py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="font-semibold mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>Product</h4>
              <ul className="space-y-2 text-[#717182]" style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px' }}>
            ...
            <div>
              <h4 className="font-semibold mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>Company</h4>
              <ul className="space-y-2 text-[#717182]" style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px' }}>
            ...
            <div>
              <h4 className="font-semibold mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>Legal</h4>
              <ul className="space-y-2 text-[#717182]" style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px' }}>
          ...
          <div className="border-t border-black/10 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6 mt-4 md:mt-0">
              <a href="https://www.linkedin.com/company/voxd-ai/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="text-[#717182] hover:text-[#0B3B2E] transition-colors">LinkedIn</a>
              <a href="https://www.instagram.com/voxd.ai?igsh=MWR3b3RtcHFrNTB5Mg%3D%3D" target="_blank" rel="noopener noreferrer" className="text-[#717182] hover:text-[#0B3B2E] transition-colors">Instagram</a>
            </div>
          </div>
        </div>
      </footer>
