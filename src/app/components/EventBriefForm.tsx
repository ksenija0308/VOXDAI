...
import { X as XIcon, Calendar, MapPin, Briefcase, Tag, Building2, Linkedin, Check, Copy } from 'lucide-react';
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  className={errors.eventDate ? 'border-[#d4183d]' : ''}
                />
                {errors.eventDate && (
              ...
              <div>
                ...
                <Input
                  ...
                  className={errors.eventTime ? 'border-[#d4183d]' : ''}
                />
                {errors.eventTime && (
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-[#f9f9f9] rounded-lg p-4 border border-[#e9ebef]">
              ...
              <div className="space-y-2 text-[#717182]" style={{ fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>
                ...
                <p><strong className="text-black">Date:</strong> {new Date(formData.eventDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })} at {formData.eventTime}</p>
              </div>
            </div>
          </div>
        )}
